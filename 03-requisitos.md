...
| RF-04 | El sistema debe calcular el quórum de confirmación evaluando que se alcance el 70% general y priorizando la presencia mínima de instrumentos base sobre la sección vocal. | Calcular quórum de confirmación (Regla del 75% e instrumentos clave) |
